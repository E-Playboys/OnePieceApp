        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkTo = table.Column<int>(type: "int", nullable: false),
                    LinkToId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewsFeedId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medias_Episodes_AnimeId",
                        column: x => x.AnimeId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Medias_Feeds_NewsFeedId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medias_AnimeId",
                table: "Medias",
                column: "AnimeId");

            migrationBuilder.CreateIndex(
                name: "IX_Medias_MangaId",
                table: "Medias",
                column: "MangaId");

            migrationBuilder.CreateIndex(
                name: "IX_Medias_NewsFeedId",
                table: "Medias",
                column: "NewsFeedId");
        }
